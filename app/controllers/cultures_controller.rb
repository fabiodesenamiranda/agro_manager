...
class CulturesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(cultures_path, status: :see_other, notice: "Culture was successfully destroyed.") }
  ...
  private
    ...
    def set_culture
      @culture = Culture.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def culture_params
      params.expect(culture: [ :name, :description ])
    end
end
